...
var AppComponent = (function () {
    function AppComponent(featureService, surveyService, feedbackService, productService, resultsService, datePipe) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.featureSubscription = __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].forkJoin([
            ...
            var features = _a[0], surveys = _a[1], productGroups = _a[2], feedback = _a[3], results = _a[4];
    ...
    AppComponent.prototype.getProductName = function (productId) {
        ...
        if (this.productGroups) {
            this.productGroups.forEach(function (productGroup) {
                var matchingProduct = productGroup.products.find(function (product) {
    ...
    AppComponent.prototype.afterSurveyChange = function (event) {
        this.surveySlide = event.currentSlide;
    };
    AppComponent.prototype.afterSessionChange = function (event) {
    ...
    AppComponent.prototype.generateEventLink = function (event) {
        var startDate = this.datePipe.transform(event.startDate, 'yMMddThhmmss');
        var endDate = this.datePipe.transform(event.endDate, 'yMMddThhmmss');
        var title = 'DXP Feedback Session: ' + this.getProductName(event.productId);
    ...
    AppComponent.prototype.calculateSurveyPaging = function (currentSlideNumber) {
        var comp = this.surveyModal;
        return this.calculatePaging(currentSlideNumber, comp);
    };
    AppComponent.prototype.calculateSessionPaging = function (currentSlideNumber) {
        var comp = this.sessionModal;
        return this.calculatePaging(currentSlideNumber, comp);
    };
    AppComponent.prototype.calculatePaging = function (currentSlideNumber, comp) {
        var total = ((currentSlideNumber + comp.config.slidesToShow) > comp.slides.length) ?
            comp.slides.length :
            currentSlideNumber + comp.config.slidesToShow;
        var start = currentSlideNumber;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])('surveyModal'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_8_ngx_slick__["a" /* SlickComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8_ngx_slick__["a" /* SlickComponent */]) === "function" && _a || Object)
], AppComponent.prototype, "surveyModal", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_13" /* ViewChild */])('sessionModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_8_ngx_slick__["a" /* SlickComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8_ngx_slick__["a" /* SlickComponent */]) === "function" && _b || Object)
], AppComponent.prototype, "sessionModal", void 0);
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__services_feature_service__["a" /* FeatureService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_feature_service__["a" /* FeatureService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__services_survey_service__["a" /* SurveyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_survey_service__["a" /* SurveyService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__services_feedback_service__["a" /* FeedbackService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_feedback_service__["a" /* FeedbackService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_3__services_product_service__["a" /* ProductService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_product_service__["a" /* ProductService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_7__services_results_service__["a" /* ResultsService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__services_results_service__["a" /* ResultsService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_9__angular_common__["c" /* DatePipe */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__angular_common__["c" /* DatePipe */]) === "function" && _h || Object])
], AppComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ngx_slick__ = __webpack_require__("../../../../ngx-slick/index.js");
