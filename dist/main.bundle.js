...
var AppComponent = (function () {
    function AppComponent(featureService, surveyService, feedbackService, productService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.featureSubscription = __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].forkJoin([featureObservable, surveyObservable, productObservable, feedbackObservable])
            .subscribe(function (_a) {
            var features = _a[0], surveys = _a[1], products = _a[2], feedback = _a[3];
